...
public class Article {
	...
	// -------------------------------------------------------------------------------
	public Article(int idArticle, String nomArticle, String description, LocalDate dateDebut, LocalDate dateFin,
			int prixInitial, int prixVente, Utilisateur utilisateur, Categorie categorie, String urlImage, String rue,
