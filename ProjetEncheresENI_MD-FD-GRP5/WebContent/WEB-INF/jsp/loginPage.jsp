...
<body class="d-flex flex-column h-100">
	...
	<a href="forgottenPassword"><button class="btn-secondary">Mot de passe oublié</button></a> <a href="createAccount"><button class="btn-secondary">Créer un compte</button></a> <c:if test="${!empty unknown || !empty wrongPass}">
		<br>
