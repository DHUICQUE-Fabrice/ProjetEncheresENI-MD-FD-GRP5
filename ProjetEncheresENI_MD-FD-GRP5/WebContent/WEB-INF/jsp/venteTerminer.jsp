	...
	<main id="formulaire" class="col-12 col-sm-8 col-md-8">
		<form>
			...
			<div class="form group-row">
				...
				<label for="offre" class="col-form-label"> Pts par </label>
				<input name="acheteur" type="text" class="col-form-control" id="acheteur" readonly>
			</div>
			...
			<div  class="form group-row">
				<label for="finEnchere" class="col-form-label">Fin de l'enchère :</label>
  				<input name="finEnchere" type="text" class=" col-form-control" id="finEnchere" readonly>
			</div>
			...
			<div class="form group-row">
				<button class="btn btn-primary" type="submit">Retour</button>
 				...
 				<button class="btn btn-primary" type="submit">Contacter l'acheteur</button>
 			</div>
		</form>
	</main>
</div>
